print(" PLEASE NOTE:\n i. MAKE SURE THE CAPS LOCK ON YOUR KEYBOARD IS NOT ON."
      "\n ii. READ EVERY QUESTION CAREFULLY BEFORE ANSWERING AS THERE IS JUST ONE "
      "ATTEMPT EVERY QUESTION.\n iii. AFTER CHOOSING YOUR PREFERRED OPTION PLEASE "
      "CLICK ON ENTER-KEY TO GO TO THE NEXT QUESTION.")
